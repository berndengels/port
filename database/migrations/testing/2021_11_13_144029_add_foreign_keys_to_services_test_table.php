...
class AddForeignKeysToServicesTestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('services', function (Blueprint $table) {
            ...
            $table->foreign('price_type_id', 'services_ibfk_2')->references('id')->on('price_types')->onUpdate('CASCADE')->onDelete('CASCADE');
        });
    }
