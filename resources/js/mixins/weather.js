			...
			axios.get('api/weather')
				.then(resp => {
					...
					this.weatherData = {
						...
						Sonnenaufgang:          dateSunrise.getHours() + ":" + this.zeroFill(dateSunrise.getMinutes()) + " Uhr",
						Sonnenuntergang:        dateSunset.getHours() + ":" + this.zeroFill(dateSunset.getMinutes()) + " Uhr",
						Windrichtúng:           this.convertDegreesToWindDirection(r.wind.deg),
						Windgeschwindigkeit:    this.msToBft(r.wind.speed) + " Bft",
