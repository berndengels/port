            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <jet-dropdown align="right" width="48" v-if="$page.props.auth.user">
                                    <template #trigger>
                                ...
                                <jet-nav-link v-else align="right" width="48"
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('caravans.index')" :active="route().current('caravans.index')">
                            Caravans
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link :href="route('caravanDates.index')" :active="route().current('caravanDates.index')">
                            Caravan Rezeption
                        </jet-responsive-nav-link>
                    </div>
