                        ...
                        <form class="mt-5" @submit.prevent>
                            ...
                            <div class="form-floating mt-2">
                                <select id="cranable_id" v-model="craneDate.cranable_id" class="form-select">
                                    ...
                                    <option v-for="item in boats" :key="item.id" :value="item.id">{{
                                            item.name
                                        }}
                                    </option>
                                </select>
...
export default {
    ...
    mounted() {
        $('.fc-header-toolbar', '.calendar').mousedown(e => {
            window.alert('click');
            console.info('click')
        });
    },
    ...
    methods: {
        ...
        selectDate(arg) {
            ...
            this.craneDate.crane_date = this.selectedDate;
            this.showForm = true;
        },
        handleUpdate(data) {
            this.update(data)
