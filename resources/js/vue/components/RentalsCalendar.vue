			...
			<div class="card-header">
				...
				<div v-if="countOffers > 1" class="float-end">
					...
					<span v-if="offers.Houseboat" class="ms-2 cursor-pointer">
                        <input @change="changeFilter" v-model="filter.Houseboat" type="checkbox" id="Houseboat"
							   name="Houseboat">
                        <label for="Houseboat">Hauseboote</label>
                    </span>
					<span v-if="offers.Apartment" class="ms-2 cursor-pointer">
                        <input @change="changeFilter" v-model="filter.Apartment" type="checkbox" id="Apartment"
							   name="Apartment">
