...
@section('main')
	<div class="row m-sm-2 m-md-5 align-self-center">
		<div class="m-auto col-sm-12 col-md-6 align-content-center">
			<h1 class="m-3 fs-3 dark-grey">{{ __('Kunden Login') }}</h1>
			<div>
				<x-form class="mx-3" method="POST" action="{{ route('customer.login') }}">
					@if( isset($redirectTo) )
					...
					<div class="mt-3">
						@if (Route::has('customer.password.request'))
							<a class="link-secondary" href="{{ route('customer.password.request') }}">
