...
@section('main-full')
<div class="bg-main dashboard d-flex">
    <div id="carousel"
         class="carousel carousel-fade"
         data-bs-ride="carousel"
    >
        <div class="carousel-indicators">
            <button type="button" data-bs-target="#carousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Boote"></button>
            ...
            <button type="button" data-bs-target="#carousel" data-bs-slide-to="3" aria-label="Dienstleistungen"></button>
        </div>
                ...
                <div class="boat">
                    <div class="carousel-caption">
                        ...
                        <p>
                            ...
                            Sommer- und Winterlager Preis-Konfiguration. Automatische Erstellung von Rechnungen inkl. einer
                ...
                <div class="houseboat">
                    <div class="carousel-caption">
                        ...
                        <p>
                            ...
                            vermieten wollen. Hier können Sie die Tagespreise je nach Saison (Haupt, Zwischen, Neben-Saison)
                ...
                <div class="service">
                    <div class="carousel-caption">
                        ...
                        <p>
                            ...
                            typische Service-Leistungen wie Schleifarbeiten, Polieren, Antifouling-Anstrich oder anderes
