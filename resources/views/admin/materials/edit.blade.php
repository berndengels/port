...
@section('main')
    <div>
        ...
        <x-form method="post" :action="route('admin.materials.update', $material)" class="w-half mt-3">
            @method('put')
            @bind($material)
            ...
            <x-form-group class="row mt-2" label="<strong>Material Ergiebigkeit</strong><br>pro Maßeinheit benötigte Menge an Material in einer bestimmten Maßeinheit">
