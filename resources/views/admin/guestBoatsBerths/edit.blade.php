...
@section('main')
    <div class="p-6">
        ...
        <x-form name="frm" method="post" :action="route('admin.guestBoatBerths.update', $guestBoatBerth)" class="w-full lg:w-1/2">
            @method('put')
            @bind(guestBoatBerth)
            <x-form-input name="enabled" type="checkbox" label="Aktiv" />
