        ...
        <div class="row mt-3">
            <div class="col-sm-12 col-md-4">
                <x-form method="post" :action="route('admin.config.settings.update', $setting)" class="w-full">
                    ...
                    <x-form-input id="iban" name="iban" label="IBAN" placeholder="IBAN" pattern="^DE\d{2}[ ]\d{4}[ ]\d{4}[ ]\d{4}[ ]\d{4}[ ]\d{2}|DE\d{20}$" title="Eine deutsche IBAN hat 22 Stellen und beginnt mit DE" />
