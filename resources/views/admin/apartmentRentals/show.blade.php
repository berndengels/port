	...
	<div>
		<div class="clearfix">
			<div class="float-start">
				<x-btn-back route="{{ route('admin.apartmentRentals.index') }}"/>
				<x-btn-edit route="{{ route('admin.apartmentRentals.edit', $houseboatDate) }}"/>
			</div>
			<div class="float-end">
				<x-btn-print route="{{ route('admin.apartmentRentals.print', $houseboatDate) }}"/>
				<x-btn-invoice :route="route('admin.apartmentRentals.sendInvoice', $houseboatDate)"/>
			</div>
		</div>
				...
				<div class="col-11 col-lg-4">
					<div class="card">
						<div class="card-header">
							<trong>Hausboot {{ $houseboatDate->houseboat->name }}</trong>
						</div>
						<div class="card-body p-3">
							...
							<div class="row">
								...
								<div class="col-auto"><a href="mailto:{{ $houseboatDate->customer->email }}"
														 target="_blank">
