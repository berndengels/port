...
@section('main')
	<div class="container">
		<div class="w-100">
			...
			<h5 class="w-100">Rechnung Miete für
				das {{ __(class_basename($rental->rentable)) }} {{ $rental->rentable->name }}
				vom {{ $rental->from->format('d.m.Y') }} bis {{ $rental->until->format('d.m.Y') }}</h5>
			<!--div class="row mt-3">
