	...
	<div>
		<div class="clearfix">
			<div class="float-start">
				<x-btn-back route="{{ route('admin.houseRentals.index') }}"/>
				<x-btn-edit route="{{ route('admin.houseRentals.edit', $houseboatDate) }}"/>
			</div>
			<div class="float-end">
				<x-btn-print route="{{ route('admin.houseRentals.print', $houseboatDate) }}"/>
				<x-btn-invoice :route="route('admin.houseRentals.sendInvoice', $houseboatDate)"/>
			</div>
		</div>
