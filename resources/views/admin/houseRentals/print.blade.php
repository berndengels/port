...
@section('main')
	<div class="container">
		<div class="w-100">
			...
			<h5 class="w-100">Rechnung für Miete des Hausboots {{ $houseboatDate->houseboat->name }}
				vom {{ $houseboatDate->from->format('d.m.Y') }} bis {{ $houseboatDate->until->format('d.m.Y') }}</h5>
			<div class="row mt-3">
