                    ...
                    <div class="mt-3 wrapper{{ ucfirst(Str::camel($pc->key)) }}">
                        ...
                        @if($pc->priceType->is_time)
                            ...
                            <div class="durationWrapper">
                                <x-form-input class="calc duration" id="duration_{{ $pc->key }}" name="duration_{{ $pc->key }}" type="number" step="0.1" min="0" label="Arbeitsdauer in {{ $pc->priceType->name_units }}" placeholder="Arbeitsdauer {{ $pc->priceType->name_units }}"
                                    :bind="false"
