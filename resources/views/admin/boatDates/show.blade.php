        ...
        <div class="container mt-3 ms-0 ps-2 ps-lg-0">
            <div class="row gy-3 ps-0">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto"><a href="mailto:{{ $boatDate->boat->customer->email }}" target="_blank">
                ...
                <div class="col-11 col-lg-2">
                    <div class="card">
                        <div class="card-header"><strong>Saison {{ config('port.main.boat.dates.modi')[$boatDate->modus] }}</strong></div>
                        <div class="card-body p-3">
                            <div class="row">
