					...
					<tr>
						<td align="center" valign="top">
							<h3 style="height: 40px; line-height: 40px; background-color: #f56857; color: #ffffff;">
								There has been an exception thrown on {{ env('APP_URL', 'unknown') }}</h3>
							<table class="emailExceptionTable" style="text-align: left;" border="0" cellspacing="0"
								...
								@isset($user)
									<tr>
										...
										<td><strong>{{ $user->name ?? ($user->username ?? null) }} <a
														href="mailto:{{ $user->email }}"
														target="_blank">{{ $user->email }}</a></strong></td>
									</tr>
								@endisset
								<tr>
							...
							<table align="center" style="text-align: center;" border="0" cellspacing="0"
								   cellpadding="0">
								<tr>
							...
							<table align="center" style="text-align: center;" border="0" cellspacing="0"
								...
								<tr>
									<td align="left"
										style="text-align: left;">{!! nl2br($exception->getTraceAsString()) !!}</td>
								</tr>
							</table>
						</td>
					</tr>
...
@else
	<h3>Sorry, no request data given</h3>
@endisset
</body>
</html>
