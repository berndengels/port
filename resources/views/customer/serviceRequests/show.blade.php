	...
	<div class="container-fluid mt-3 ms-0 ps-2 ps-lg-0">
		<div class="row gy-3 ps-0">
			<div class="col-11 col-lg-4">
				<div class="card">
					<div class="card-header">
						<trong>Boot {{ $serviceRequest->boat->name }}</trong>
					</div>
			...
			<div class="col-11 col-lg-4">
				<div class="card">
					<div class="card-header">
						<trong>Auftrags Daten</trong>
					</div>
					<div class="card-body p-3">
						<div class="row pe-3">
							<div class="col-12"><strong
										class="text-primary">{!! $serviceRequest->description !!}</strong></div>
						</div>
						<div class="row">
					...
					<div class="card">
						...
						<div class="card-body p-3">
							<div class="row">
								...
								<div class="col-auto">{{ ($service->getServicePrice($serviceRequest->boat)) }} €
									({{ $service->price }} € {{ $service->priceType->name }})
								</div>
							</div>
									...
									<div class="col-auto">
										<ul class="list-disc ml-3">
											@foreach($service->materials as $material)
												...
												<li>
													Ergiebigkeit: {{ $material->fertility }} {{ $material->fertility_unit }}
