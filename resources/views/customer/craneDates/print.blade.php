...
@section('main')
	<div class="container justify-content-center">
		<div class="w-100">
			...
			<h5 class="w-100">Rechnung für Dauerliegeplatz Saison: {{ __($boatDate->modus) }}
				ab {{ $boatDate->from->format('Y') }} bis {{ $boatDate->until->format('d.m.Y') }}</h5>
			<div class="row mt-3">
